 ...
 * Vertex Buffer Object, Vertext Array Object 생성
 * 
 *  */
class Controller{
    public:
    ...
    private:
        ...
        std::shared_ptr<MyShader> m_vertexShaderPtr; 
        std::shared_ptr<MyShader> m_fragmentShaderPtr; 
        std::shared_ptr<MyProgram> m_myprogramPtr; 
